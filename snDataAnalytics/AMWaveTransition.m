...
- (void)handlePan:(UIScreenEdgePanGestureRecognizer *)gesture
{
    ...
    _animationProgress = touch.x/SCREEN_WIDTH;
//    NSLog(@"translation.x:%f",translation.x);
//    NSLog(@"_animationProgress:%f",_animationProgress);
...
//         [self.navigationController.view addSubview:fromVC.view];
        [self.navigationController.view addSubview:toVC.view];
        toVC.view.alpha = 0.0;
//        NSLog(@"toView origin.x:%f,origin.y:%f,width:%f,height:%f",toVC.view.frame.origin.x,toVC.view.frame.origin.y, toVC.view.frame.size.width,toVC.view.frame.size.height);
//        NSLog(@"fromVC origin.x:%f,origin.y:%f,width:%f,height:%f",fromVC.view.frame.origin.x,fromVC.view.frame.origin.y, fromVC.view.frame.size.width,fromVC.view.frame.size.height);
...
//            NSLog(@"fromViewCells %lu, origin.x:%f",(unsigned long)idx,view.frame.origin.x);
        }];
...
//        fromVC.view.alpha = 1.3 - _animationProgress;
        toVC.view.alpha   = _animationProgress - 0.3;
...
//                    NSLog(@"fromViewCells %lu, origin.x:%f",(unsigned long)idx,view.frame.origin.x);
                ...
                [[toVC visibleCells] enumerateObjectsUsingBlock:^(UIView *view, NSUInteger idx, BOOL *stop) {
                    ...
                    rect.origin.x = -SCREEN_WIDTH;
                    view.frame = rect;
//                    NSLog(@"toViewCells %lu, origin.x:%f",(unsigned long)idx,view.frame.origin.x);
...
//    fromVC.view.alpha = 1.0;
//    toVC.view.frame = CGRectMake(delta, fromVC.view.frame.origin.y, SCREEN_WIDTH,SCREEN_HEIGHT );
//    NSLog(@"fromVC origin.x:%f,origin.y:%f,width:%f,height:%f",fromVC.view.frame.origin.x,fromVC.view.frame.origin.y, fromVC.view.frame.size.width,fromVC.view.frame.size.height);
//    NSLog(@"fromVC.alpha:%f",fromVC.view.alpha);
    ...
    [UIView animateWithDuration:0.5 delay:0 options:UIViewAnimationOptionCurveEaseIn animations:^{//        toVC.view.alpha = 1.0;
...
//            toVC.view.frame = CGRectMake(-SCREEN_WIDTH, 44.0, 320, 524);
...
//                toVC.view.frame = CGRectMake(0, 44.0, 320, 524);
